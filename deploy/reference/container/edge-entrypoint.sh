...
require_value EDGE_METRICS_LISTEN_PORT "${EDGE_METRICS_LISTEN_PORT:-}"
...
safe_port EDGE_METRICS_LISTEN_PORT "$EDGE_METRICS_LISTEN_PORT" 1024
...
envsubst '${DIRECTOR_PUBLIC_HOST} ${PUBLIC_LISTEN_PORT} ${DIRECTOR_UPSTREAM_HOST} ${DIRECTOR_UPSTREAM_PORT} ${DIRECTOR_MAX_BODY_SIZE} ${EDGE_METRICS_LISTEN_PORT} ${DIRIZHOR_NGINX_INCLUDE_DIR}' \
