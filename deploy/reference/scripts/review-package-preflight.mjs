...
export const requiredReviewFiles = Object.freeze([
  ...
  'deploy/reference/conformance/reviewer-tracks-v1.json',
  'deploy/reference/reviewer-assignments-template-v1.json',
  'deploy/reference/reviewer-result-template-v1.json',
  'deploy/reference/scripts/architecture-review.mjs',
  'deploy/reference/scripts/reviewer-assignments.mjs',
  'deploy/reference/scripts/reviewer-results.mjs',
  'deploy/reference/scripts/reviewer-handoff.mjs',
  ...
  'deploy/reference/scripts/git-source-manifest.mjs',
